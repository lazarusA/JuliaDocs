...
If `T` is a [`AbstractFloat`](/base/numbers#Core.AbstractFloat) type, then it will return the closest value to `x` representable by `T`.
...
1. Within a function body without any arguments, to override the entire effect modeling of the enclosing method.
  
1. Applied to a code block, to override the local effect modeling of the applied code block.
...
See also [`@time`](/tutorials/profile#@time).
...
See also [`@time`](/tutorials/profile#@time), [`@timed`](/base/base#Base.@timed), [`@elapsed`](/base/base#Base.@elapsed), [`@allocated`](/base/base#Base.@allocated), and [`@allocations`](/base/base#Base.@allocations).
...
See also [`@time`](/tutorials/profile#@time), [`@timev`](/base/base#Base.@timev), [`@elapsed`](/base/base#Base.@elapsed), [`@allocated`](/base/base#Base.@allocated), [`@allocations`](/base/base#Base.@allocations), and [`@lock_conflicts`](/base/base#Base.@lock_conflicts).
...
See also [`@time`](/tutorials/profile#@time), [`@timev`](/base/base#Base.@timev), [`@timed`](/base/base#Base.@timed), [`@allocated`](/base/base#Base.@allocated), and [`@allocations`](/base/base#Base.@allocations).
...
See also [`@allocations`](/base/base#Base.@allocations), [`@time`](/tutorials/profile#@time), [`@timev`](/base/base#Base.@timev), [`@timed`](/base/base#Base.@timed), and [`@elapsed`](/base/base#Base.@elapsed).
...
See also [`@allocated`](/base/base#Base.@allocated), [`@time`](/tutorials/profile#@time), [`@timev`](/base/base#Base.@timev), [`@timed`](/base/base#Base.@timed), and [`@elapsed`](/base/base#Base.@elapsed).
...
See also [`@time`](/tutorials/profile#@time), [`@timev`](/base/base#Base.@timev) and [`@timed`](/base/base#Base.@timed).
...
`sym ∈ names(SomeModule)` does _not_ imply `isdefined(SomeModule, sym)`. `names` will return symbols marked with `public` or `export`, even if they are not defined in the module.
