...
There is another alternative interface to `@ccall`. This interface is slightly less convenient but it does allow one to specify a [calling convention](/manual/calling-c-and-fortran-code#calling-convention).
