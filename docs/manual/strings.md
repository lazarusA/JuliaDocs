...
Besides being used for the [`VERSION`](/base/constants#Base.VERSION) constant, `VersionNumber` objects are widely used in the `Pkg` module, to specify packages versions and their dependencies.
